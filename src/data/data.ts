...
export const testimonialsData: Testimonial[] = [
    {
        ...
        review: 'मतलब जीरो से एक तरीके से उठाया है। तो हर एक चीज के लिए',
        videoId: '_1P9UmcOV4Y',
        prevRole: 'Career Transition',
        currentRole: 'DevOps Professional',
        salary: '₹10+ LPA',
        stars: 5,
    },
    {
        name: 'DevOps Student',
        review: 'Practical hands-on training with real-world projects. The mentorship was exceptional.',
        videoId: 'qrwztLxaSio',
        prevRole: 'IT Professional',
        currentRole: 'DevOps Engineer',
        salary: '₹12 LPA',
        stars: 5,
    },
    {
        name: 'Advanced DevOps Graduate',
        review: 'Complete DevOps journey from basics to advanced. Certified and job-ready with real projects.',
        videoId: 'slqQ9akaT_w',
        prevRole: 'Student',
        currentRole: 'Certified DevOps Engineer',
        salary: '₹10+ LPA',
        stars: 5,
    },
];
...
export const footerData = {
    ...
    socialLinks: [
        { icon: "FaYoutube", href: "https://www.youtube.com/@switchtodevops", label: "YouTube" },
        { icon: "FaTwitter", href: "https://x.com/switchtodevops?s=20", label: "Twitter" },
        { icon: "FaInstagram", href: "https://www.instagram.com/switchtodevops?igshid=eWtwMnZyMmZjOXZ5", label: "Instagram" },
    ],
    contactInfo: [
